    ...
    <div id="app">
        <div class="w-full bg-gray-800 md:pt-20 md:pb-20 text-white"> <!-- h-96 -->
			<div class="lg:max-w-5xl mx-auto md:px-4 p-4">
                ...
                <h4 class="text-xs">Source: <a class="border-b border-dotted text-blue-600 border-blue-600 hover:text-blue-800 hover:border-blue-800" target="_blank" href="https://www.health.pa.gov/topics/disease/Pages/Coronavirus.aspx">Pennsylvania Deptartment of Health</a> &middot; Last updated 3/22/2020 12:00 p.m.</h4>
